...
//        DatabaseReference requestReference = mDatabase.getReference("Requests").child(requestId);
//        request = new Request();
//        ValueEventListener requestListener = new ValueEventListener() {
//            @Override
//            public void onDataChange(DataSnapshot dataSnapshot) {
//                request.setBookId(dataSnapshot.child("bookId").getValue().toString());
//                Log.e("hello", dataSnapshot.child("bookId").getValue().toString());
//                request.setBorrowerId(dataSnapshot.child("borrowerId").getValue().toString());
//                request.setStatus(dataSnapshot.child("status").getValue().toString());
//                request.setOwnerId(dataSnapshot.child("ownerId").getValue().toString());
//                // must add location when implemented
//            }
//            @Override
//            public void onCancelled(DatabaseError databaseError) {
//                Log.w("cancelled", databaseError.toException());
